...
class MainGameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('ricedoughspoon', '/assets/07_ricedoughspoon.png')
        this.load.image('ricedoughbowl', '/assets/09_ricedoughbowl.png');
        this.load.image('redbeanpastebowl', '/assets/10_redbeanpastebowl.png');
        this.load.image('flatdough', '/assets/12_flatdough.png')
        this.load.image('doughwithpaste', '/assets/13_doughwithpaste.png')
        this.load.image('tray', '/assets/14_tray.png')
        this.load.image('strawberry', '/assets/15_strawberry.png');
        this.load.image('grape', '/assets/16_grape.png');
        this.load.image('tangerine', '/assets/17_tangerine.png');
        this.load.image('mango', '/assets/18_mango.png');
        this.load.image('scoreboard', '/assets/19_scoreboard.png');
        this.load.image('gaugebar', '/assets/21_gaugebar.png');
        this.load.image('curtain', '/assets/22_curtain.png')
        this.load.image('openedcurtain', '/assets/23_openedcurtain.png')
        this.load.image('monitor', '/assets/25_monitor.png')
        this.load.image('strawcus', '/assets/26_strawcus.png')
        this.load.image('grapecus', '/assets/27_grapecus.png')
        this.load.image('tangcus', '/assets/28_tangcus.png')
        this.load.image('mangocus', '/assets/29_mangocus.png')
        this.load.image('angrycus', '/assets/30_angrycus.png')
        this.load.image('specus', '/assets/31_specus.png')
        this.load.image('excitedham', '/assets/32_excitedham.png')
        this.load.image('strawdough', '/assets/34_strawdough.png')
        this.load.image('grapedough', '/assets/35_grapedough.png')
        this.load.image('tangerdough', '/assets/36_tangerdough.png')
        this.load.image('mangodough', '/assets/37_mangodough.png')
        this.load.image('order', '/assets/38_order.png')
        this.load.image('strawmochi', '/assets/39_strawmochi.png');
        this.load.image('grapemochi', '/assets/40_grapemochi.png');
        this.load.image('tangermochi', '/assets/41_tangermochi.png');
        this.load.image('mangomochi', '/assets/42_mangomochi.png');
        this.load.image('header2', '/assets/48_header2.png')
        this.load.image('doughboard', './assets/51_doughboard.png')
        this.load.image('pastedoughboard', '/assets/52_pastedoughboard.png')
        this.load.image('three', '/assets/54_three.png');
        this.load.image('two', '/assets/55_two.png');
        this.load.image('one', '/assets/56_one.png');
        this.load.image('start', '/assets/57_start.png');
        this.load.audio('pop', '/assets/70_pop.mp3');
        this.load.audio('success', '/assets/71_success.mp3');
        this.load.audio('bell', '/assets/72_bell.mp3');
        this.load.audio('fail', '/assets/73_fail.mp3');
    }
